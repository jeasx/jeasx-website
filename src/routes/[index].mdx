...
<Highlight title="2026-02-20 - Jeasx 2.4.0 released">
🎉 You can now use all existing configuration options and plugins for `esbuild` and `Fastify`. [Learn more...](/news)
</Highlight>
...
<Feature headline="jsx-async-runtime" link="https://github.com/jeasx/jsx-async-runtime" icon={{ html: IconInstallation }}>
