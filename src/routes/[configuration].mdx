...
To edit `.env.js` with [VSCode](https://code.visualstudio.com/) as JavaScript file, you should add the following config to your settings:
...
To edit `.env.js` with [Zed](https://zed.dev/) as JavaScript file, you should add the following config to your settings:
...
If you want to [use MDX with plugins](https://mdxjs.com/docs/extending-mdx), you can configure them in `.env.js` after installing them to your project:
