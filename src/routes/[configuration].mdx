...
To edit `.env.js` with VSCode as JavaScript file, you should add the following config to your settings:
...
To edit `.env.js` with Zed as JavaScript file, you should add the following config to your settings:
