...
Defaults to `["chrome130", "edge130", "firefox130", "safari18"]`, full documentation at [esbuild website](https://esbuild.github.io/api/#target)

### ESBUILD_MDX_OPTIONS

[MDX compile options reference](https://mdxjs.com/packages/mdx/#compileoptions), default options applied by Jeasx: 
...
If you want to [extend MDX with plugins](https://mdxjs.com/docs/extending-mdx), you can configure them in `.env.js` after installing them to your project:
