...
Jeasx is dedicated to delivering a highly stable platform for web development. It is recommend reviewing the changelog prior to upgrading your project.
...
**Patch:** No changes to your project are typically needed.
