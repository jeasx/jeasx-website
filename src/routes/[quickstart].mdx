...
Jeasx is developed and tested with the <b>latest LTS</b> (24.x) and <b>latest release</b> (25.x) version of Node.js. Older versions are not officially supported, but may work.
