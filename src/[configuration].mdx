...
- Install `@fastify/formbody` if your project requires _POST_ form support.
- Install `@fastify/cookie` if you need to handle HTTP cookies.
- Install `@fastify/multipart` if your project handles file uploads.
